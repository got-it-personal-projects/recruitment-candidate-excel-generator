...
class _ErrorCode:
    ...
    MISSING_AUTHORIZATION_HEADER = 401001
    INVALID_ACCESS_TOKEN = 401002
...
class MissingAuthorizationHeader(BaseError):
    status_code = StatusCode.UNAUTHORIZED
    error_code = _ErrorCode.MISSING_AUTHORIZATION_HEADER
    error_message = _ErrorMessage.MISSING_AUTHORIZATION_HEADER
